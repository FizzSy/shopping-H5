...
export default {
    ...
    methods: {
        ...
        getCategorySubByCategoryID(categoryId) {
            axios.get(url.getCateGorySubList, { params: { categoryId: categoryId } }).then(response => {
                console.log(response)
                if (response.data.code == 200 && response.data.message) {
        ...
        onLoad() {
            ...
            if (!this.isLoad && this.categorySub.length) {
        ...
        getGoodList() {
            this.isLoad = true;
            axios.get(url.getGoodsListByCategorySubID, { params: { categorySubId: this.categorySubId, page: this.page } }).then(response => {
